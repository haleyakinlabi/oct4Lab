...
let sum = totalPopulation(states)
console.log(sum)
...
let cat1 = new Cat('Kitten', 5, 'white')
...
let wiz1 = new Wizard('Gandalf', 3000, 'You Shall Not Pass')
wiz1.castSpell()
...
//Code Here
let phone1 = ('apple', 'smartPhone', 128, 'gold', 1000)
let phone2 = ('Black Berry', 'flip phone', 10, 'black', 100)
let phone3 = ('Samsung', 'galaxyZ', 130, 'silver', 2000)
...
//Code Here
let myFirstVehicle = new Vehicle = (4, 'grey', 7000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'red', 1000, 'scooter', true)
...
//Code Here
let myFirstBoat = new Boat(4, 'blue', 20000, 'little boat', 'fishing boat', false)
